$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            var bannerContent = `
                <div style="background: rgba(0, 0, 0, 0.19); padding: 20px; border-radius: 10px;">
            ...
            // APLICAMOS LA IMAGEN DE FONDO DEL JSON
            $banner.css('background-image', 'url(' + data.imagen + ')');
            
            // EJERCICIO 2: Deslizar desde arriba
            $banner.animate({ top: '0' }, 1000, 'swing');
        },
        error: function() { $('#banner-container').text('Error cargando banner'); }
    });
